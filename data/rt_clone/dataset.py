...
class SudokuSATNetDataset(Dataset):
    def __init__(self):
        data = {}
        data_to_path = {
            "board": f"{DATA_PATH}/satnet/features.pt",
            "board_img": f"{DATA_PATH}/satnet/features_img.pt",
            "label": f"{DATA_PATH}/satnet/labels.pt",
            "perm": f"{DATA_PATH}/satnet/perm.pt",
        }
...
class SudokuPalmDataset(Dataset):
    def __init__(self, segment, limit, seed):
        ...
        zip_fname = f"{DATA_PATH}/sudoku-hard.zip"
        dest_dir = f"{DATA_PATH}/sudoku-hard/"
